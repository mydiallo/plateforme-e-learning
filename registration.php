...
$password = password_hash($password, PASSWORD_BCRYPT, array('cost' => 12));
    ...
    // $select_randsalt_query = mysqli_query($connexion, $query);
    ...
    $register_user_query = mysqli_query($connexion, $query);

    if(!$register_user_query){
        die ("Query Failed" . mysqli_error($connexion) . '' . mysqli_errno($connexion));
    }
