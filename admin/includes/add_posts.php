...
if(isset($_POST['create_post'])){
    ...
    $the_get_post_id = mysqli_insert_id($connexion);
    echo "<p class = 'bg-success'>Post Created. <a href = '../post.php?p_id={$the_get_post_id}'>View Post</a> or <a href='posts.php'>Edit More Posts</a> </p>";
